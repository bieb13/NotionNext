...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Biebie', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '爱薅羊毛的小菜鸡', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.bietalk.com', // 网站地址
